...
const int flame_mid[] = {FLAME_UP_MID, FLAME_DOWN_MID, FLAME_LEFT_MID, FLAME_RIGHT_MID};
const int flame_tip[] = {FLAME_UP_TIP, FLAME_DOWN_TIP, FLAME_LEFT_TIP, FLAME_RIGHT_TIP};
